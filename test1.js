...
var lastitem= document.firstElementChild.lastElementChild.getElementsByClassName('list')[2];
lastitem.innerHTML="Asif";

//console.log(document.firstElementChild.lastElementChild.querySelector('ul').lastElementChild.innerHTML="Asif");

document.querySelector('ul .list a').style.color='red'
console.log(document.querySelectorAll('ul .list')[1].innerHTML)